function comet3_delay(varargin)
%COMET3_DELAY 3-D Comet-like trajectories.
%
%
%% - Modified by JWM, 2014-09-19
%   
%   Added a delay
%
%%
...
if nargs < 5, delay = 0; end
if nargs == 5, [x,y,z,p,delay] = deal(args{:}); end 
